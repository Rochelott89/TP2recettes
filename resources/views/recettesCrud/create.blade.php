...
@section('content')
    ...
    @if ($errors->any())
        <div class="alert alert-danger">
            <strong>Ups!</strong> Il y a eu des problèmes avec votre entrée.<br><br>
            <ul>
    ...
    @endif
    <form action="{{ route('recettesCrud.store') }}" method="POST" >
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="ingredients" class="form-control" placeholder="Ingrédients">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
